...
| Monthly Cloud Cost | $54,828.85 |

## Background

A stage where dedicated DevOps/FinOps teams are emerging while legacy settings still remain.
...
|------------|------------------|----------|
| L3 | NAT Gateway | Network Transfer |